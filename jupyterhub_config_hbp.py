...
c.GenericOAuthenticator.oauth_callback_url = 'https://spinn-20.cs.man.ac.uk/hub/hbp/oauth_callback'
...
#c.JupyterHub.data_files_path = '/opt/local/Library/Frameworks/Python.framework/Versions/3.4/share/jupyter/hub'
...
#from jupyterhub_oauth_spawner.oauth_spawner import OAuthSpawner, create_user_folder, delete_user_folder
#c.JupyterHub.spawner_class = OAuthSpawner
#c.Spawner.notebook_dir = '/Users/jupyterhub/Notebooks/{username}'
...
c.DockerSpawner.environment = {
    "JUPYTERHUB_HOST_PORT": "spinn-20.cs.man.ac.uk"
}
...
c.Authenticator.admin_users = {'rowley'}
